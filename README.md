...
### How to
The **data** folder contains the SQL statements needed to create and populate in the tables used in the exercises. The (1 to 5) SQL files on the root folder cover the different topics of the course: subqueries and CTEs, window functions, functions by data type, data analysis applications and the final project. 
